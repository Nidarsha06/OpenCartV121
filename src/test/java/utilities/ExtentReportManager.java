...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		// Date format in single line
		String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date()); // Time stamp

		repName = "Test-Report-" + timeStamp + ".html";
		sparkReporter = new ExtentSparkReporter(System.getProperty("user.dir") + "/reports/"+repName+"");// specifying location
		...
		extent.setSystemInfo("User Name", System.getProperty("user.name")); // returns the current system user name
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * email.setAuthenticator(new DefaultAuthenticator("nidarshakr15@gmail.com",
		 * "password")); email.setSSLOnConnect(true);
		 * email.setFrom("nidarshakr15@gmail.com"); // Sender
